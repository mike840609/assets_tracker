...
async function LoginContent() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center relative overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      {/* Glassmorphism Card */}
      <div className="relative z-10 mx-auto flex w-full max-w-md flex-col justify-center space-y-8 p-10 bg-white/80 dark:bg-slate-900/70 backdrop-blur-xl border border-white/60 dark:border-slate-700/70 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.5)] rounded-3xl animate-slide-in-bottom">
        ...
        <div className="flex flex-col space-y-3 text-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-slate-900 to-slate-600 dark:from-slate-100 dark:to-slate-400 bg-clip-text text-transparent">
            {t("title")}
          </h1>
        ...
        >
          <Button
            className="w-full h-12 text-[15px] font-medium tracking-wide bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5 rounded-xl flex items-center justify-center gap-3"
            type="submit"
          >
        ...
        {isPreview && (
          <>
            <div className="flex items-center gap-3 pt-2">
              ...
              <span className="text-xs text-slate-400 dark:text-slate-500 font-medium">Preview Mode</span>
              <div className="flex-1 h-px bg-slate-200 dark:bg-slate-700" />
            </div>
            ...
            >
              <div className="flex flex-col gap-3">
                <input
                  ...
                  required
                  className="h-12 w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-4 text-sm text-slate-700 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
                />
                <Button
                  type="submit"
        ...
        <div className="text-center text-xs text-slate-400 dark:text-slate-500 pt-2 mb-[-1rem]">
          {t("footerBefore")}{" "}
  ...
  return (
    <Suspense fallback={
      <div className="flex min-h-screen w-full items-center justify-center bg-slate-50 dark:bg-slate-950">
        <div className="w-full max-w-md rounded-3xl bg-white/80 dark:bg-slate-900/70 p-10 space-y-8 animate-pulse">
          <div className="flex flex-col items-center space-y-3">
            <div className="w-16 h-16 rounded-xl bg-emerald-100 dark:bg-emerald-900/40" />
