...
export type ExchangeRateWhereUniqueInput = Prisma.AtLeast<{
  fromCurrency_toCurrency?: Prisma.ExchangeRateFromCurrencyToCurrencyCompoundUniqueInput
  AND?: Prisma.ExchangeRateWhereInput | Prisma.ExchangeRateWhereInput[]
  OR?: Prisma.ExchangeRateWhereInput[]
  NOT?: Prisma.ExchangeRateWhereInput | Prisma.ExchangeRateWhereInput[]
  fromCurrency?: Prisma.StringFilter<"ExchangeRate"> | string
...
export type ExchangeRateOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"fromCurrency" | "toCurrency" | "rate" | "updatedAt", ExtArgs["result"]["exchangeRate"]>
...
export interface ExchangeRateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `fromCurrency`
   * const exchangeRateWithFromCurrencyOnly = await prisma.exchangeRate.findMany({ select: { fromCurrency: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ExchangeRates and only return the `fromCurrency`
   * const exchangeRateWithFromCurrencyOnly = await prisma.exchangeRate.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ExchangeRates and only return the `fromCurrency`
   * const exchangeRateWithFromCurrencyOnly = await prisma.exchangeRate.updateManyAndReturn({
   *   select: { fromCurrency: true },
   *   where: {
   *     // ... provide filter here
   *   },
